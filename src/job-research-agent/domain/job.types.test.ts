...
import {
  SENIORITY_REPORT_GROUP_V2_ORDER,
  type SeniorityReportGroupV2,
} from "./job.types.js";

describe("SENIORITY_REPORT_GROUP_V2_ORDER", () => {
  it("contém exatamente os 7 grupos exportáveis na ordem canônica", () => {
  ...
  it("tem tamanho 7", () => {
    expect(SENIORITY_REPORT_GROUP_V2_ORDER).toHaveLength(7);
  });
});
