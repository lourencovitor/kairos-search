...
export const defaultJobResearchConfig: Readonly<JobResearchConfig> =
  Object.freeze<JobResearchConfig>({
    ...
    technicalKeywordProfiles: [
      ...
      {
        label: 'microservices',
        aliases: ['microservices', 'micro services', 'microsserviços'],
        weight: 8,
      },
      {
...
export function createJobResearchConfig(
  ...
  return {
    ...
    browserMcp: mergeBrowserMcpConfig(defaultJobResearchConfig.browserMcp, overrides.browserMcp),
  };
}
